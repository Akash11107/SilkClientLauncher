  ...
  class GameManager {
    ...
    async downloadJava(javaVersionCode) {
      return new Promise(async (resolve, reject) => {
        const javaPath = path.join(this.minecraftDir, "silkclient-jre", javaVersionCode, "bin", "javaw.exe");
          ...
          require("./javaManager")(javaVersionCode)
            .then(async (java) => {
              try {
                ...
                let javaDirs = [this.minecraftDir, "silkclient-jre", javaVersionCode]
                ...
                directory.forEach((dir) => {
                  ...
                  fs.mkdirSync(path.join(this.minecraftDir, "silkclient-jre", javaVersionCode, dir.name));
                });
                ...
                for (let file of filesToDownload) {
                  ...
                  let stream = fs.createWriteStream(path.join(this.minecraftDir, "silkclient-jre", javaVersionCode, file.name));
      ...
      return new Promise(async (resolve, reject) => {
        ...
        */
        ...
        const launcherOptions = {
          ...
          version,
          authorization: account || Authenticator.getAuth(account.username || "silk client" + Math.floor(Math.random() * 1000) + 100),
          memory: {
